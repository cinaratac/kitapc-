...
class Character {
  ...
  // --- BİREYSEL DÜŞÜNCE ZAMANLAYICILARI ---
  final DateTime? lastThoughtTime;      // Düşüncenin ekranda belirdiği an (20 dk sayacı için)
  final DateTime? lastThoughtCheckTime; // 2 saatlik ihtimal kontrolünün yapıldığı son an
  ...
  Character copyWith({
    ...
    DateTime? lastThoughtTime,
    DateTime? lastThoughtCheckTime,
    ...
    return Character(
      ...
      activeThought: clearThought ? null : (activeThought ?? this.activeThought),
      // Yeni alanlar
      lastThoughtTime: clearThought ? null : (lastThoughtTime ?? this.lastThoughtTime),
      lastThoughtCheckTime: lastThoughtCheckTime ?? this.lastThoughtCheckTime,
    );
  }
}